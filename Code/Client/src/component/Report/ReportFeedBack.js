...
export default function ReportFeedBack() {
  ...
  const addClaims = async (claim) => {
    console.log(claim);
    const res = await publicRequest.post("FeedBackReport/addReport", claim);
  };
    ...
    rows.map((value) => {
      setcrntdata((crntdata) => [
        ...crntdata,
        {
          ...
          Feedbackdate: value.Feedback_Date,
          FeedbackMsg: value.FeedbackMsg,
          Rate: value.Rate,
        },
      ]);
    });
            ...
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="right">date of FeedBack</TableCell>
