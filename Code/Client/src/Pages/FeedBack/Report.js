...
import FeedBackReportPopUptable from "../../component/Table/FeedbackReportTable";
...
async function fetchClaims() {
  const res = await publicRequest.get(`FeedBackReport/getAll`);
  return res;
}
...
const FeedbackReport = () => {
  ...
  const deleteClaims = (id) => {
    console.log(id);
    return publicRequest.delete(`FeedBackReport/delete/${id}`);
  };
  ...
  const deleteReq = useMutation(deleteClaims, {
    onSuccess: () => {
      ...
      queryClient.invalidateQueries("FeedBackReportdata");
    },
    onError: (error) => {
      setNotify({
        isOpen: true,
      ...
      <Container component="main" maxWidth="xl" className={classes.main}>
        ...
        >
          ...
          <Container
            ...
            ref={componentRef}
          >
            <FeedBackReportPopUptable props={params} />
          </Container>
          <div
            style={{
              display: "flex",
