...
const WarrentyForm = () => {
  ...
  const demoFunction = () => {
    setAddress("No 100 Wattegedara Road Maharagama");
    setContactNo("0717083178");
    setUser("Nimal Perera");
    setcustomerName("Nimal Perera");
    setBrand("Toyota");
    setCode("TR45056");
    setTecnician("Saman Perera");
    settechnicianContactNo("0712636041");
    setRegistarationNo("CAD6789");
    setInjectorMake("Toyota");
    setInjectorNo("KD067");
    setInjectorCode("IK0789");
    setNewParts("Add new Alloy wheels");
  };
          ...
          <Paper className={classes.paper}>
            ...
            >
              ...
              <Grid item xs={12} sm={12} className={classes.grid}>
                ...
                <Button onClick={demoFunction}>Demo</Button>
